...
__C.DATASETS.SHAPENET.RENDERING_PATH        = 'D:/Pix2Vox/datasets/shapenet/ShapeNetRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = 'D:/Pix2Vox/datasets/shapenet/ShapeNetVox32/%s/%s/model.binvox'
...
__C.CONST.N_VIEWS_RENDERING                 = 5       # Dummy property for Pascal 3D
